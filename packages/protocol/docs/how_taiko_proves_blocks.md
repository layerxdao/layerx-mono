...
A valid `txList` (until [issue #13724](https://github.com/taikoxyz/layerx-mono/issues/13724) is enabled and implemented):
...
The actual value of the public input parameters must be consistent with the values used to hash the ZKP instance (see [**LibProving**](https://github.com/taikoxyz/layerx-mono/blob/945dabc09a668678aca1296e91d567b45ad37922/packages/protocol/contracts/L1/libs/LibProving.sol#L182)).
