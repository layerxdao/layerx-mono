...
```
VITE_L1_RPC_URL=https://l1rpc.internal.layerx.build
VITE_L2_RPC_URL=https://rpc.internal.layerx.build
VITE_L3_RPC_URL=https://l3rpc.internal.layerx.build

VITE_L1_EXPLORER_URL=https://l1explorer.internal.layerx.build
VITE_L2_EXPLORER_URL=https://explorer.internal.layerx.build
VITE_L3_EXPLORER_URL=https://l3explorer.internal.layerx.build

VITE_RELAYER_URL=https://relayer.internal.layerx.build
