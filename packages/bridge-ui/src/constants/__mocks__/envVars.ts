export const L1_RPC = 'https://l1rpc.internal.layerx.build';
...
export const L1_EXPLORER_URL = 'https://l1explorer.internal.layerx.build';

export const L2_RPC = 'https://l2rpc.internal.layerx.build';
...
export const RELAYER_URL = 'https://relayer.internal.layerx.build/';
