...
This guide will help get your contract verified on LayerX!

## Prerequisites

- You have a contract deployed on LayerX and the source code available.
...
<Tabs items={["Hardhat", "Blockscout", "Foundry"]} defaultIndex="0">
  <Tab>
   <Steps>
                ...
                customChains: [
                    {
                        ...
                        chainId: 167005,
                        urls: {
                            apiURL: "https://explorer.test.layerx.build/api",
                            browserURL: "https://explorer.test.layerx.build",
                        },
                    },
                ],
            },
        ...
        Check the [LayerX block explorer](https://explorer.test.layerx.build) link from the output to see your contract was verified.
    </Steps>
  </Tab>
  <Tab>
    Follow Blockscout's [official guide](https://docs.blockscout.com/for-users/verifying-a-smart-contract) to verify your contract on LayerX's blockscout explorers.
  </Tab>
  <Tab>
